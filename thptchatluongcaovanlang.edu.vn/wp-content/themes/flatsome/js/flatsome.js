        ...
        attach: function(t) {
            jQuery(".accordion-title", t).each(function() {
                jQuery(this).off("click.flatsome").on("click.flatsome", function(t) {
                    ...
                    jQuery.fn.flickity && jQuery(this).parent().parent().find("[data-flickity-options]").flickity("resize"),
                    jQuery.fn.packery && jQuery(this).parent().parent().find("[data-packery-options]").packery("layout")) : jQuery(this).parent().parent().find(".accordion-title").removeClass("active").next().slideUp(200),
                    t.preventDefault()
                })
            })
        }
